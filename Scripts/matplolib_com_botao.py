...
slider_ax = plt.axes([0.92, 0.35, 0.03, 0.3], facecolor='red')  # Define slider position and size
slider = Slider(slider_ax, 'Max Data Points', 2, 20, valinit=max_data_points)
